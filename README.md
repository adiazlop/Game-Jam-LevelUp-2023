...
- Environmental narrative focused on ocean conservation
- Exploration and light resource-management mechanics
...
The project uses third-party assets and audio under Creative Commons and Unity Asset Store licenses. 
You can check the full list of assets used ![here]([https://example.com](https://punished-toni.itch.io/sea-dryads-protectoras-del-oceano))
